...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		repo.deleteById(id);
			...
			throw new DataIntegrityViolationException("Não é possível excluir porque há pedidos relacionados com o cliente");
		}
	}
	...
	public Cliente fromDto(ClienteNewDto objDto) {
		Cliente cliente = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getCpfOuCnpj(), TipoCliente.toEnum(objDto.getTipo()), bCPassEncod.encode(objDto.getSenha()));
